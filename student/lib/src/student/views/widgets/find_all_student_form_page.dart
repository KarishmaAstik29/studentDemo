...
import 'package:student/src/student/views/widgets/update_student_form_page.dart';
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              'idLabel'.tr+" = "+
                              studentProvider.getStudent[index].id.toString(),
                        ...
                        Column(
                          children: [
                            ...
                            },child:  Text('deleteButton'.tr),color: Theme.of(context).primaryColor,),
                          ],
                        ),
                         ...
                         Column(
                          children: [
                            ...
                            },child: Text('updateButton'.tr),color: Theme.of(context).primaryColor,),
                          ],
                        ),
                      ],
                    )
